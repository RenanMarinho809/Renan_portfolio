  ...
  return (
    <section id="contato" className="contact-section">
      ...
      >
        ...
        <p className="contact-intro">Estou disponível para oportunidades como Desenvolvedor Frontend Júnior.</p>
        <p className="contact-email">📧 Email: renanmarinho809@gmail.com</p>
